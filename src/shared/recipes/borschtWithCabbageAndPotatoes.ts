...
export const borschtWithCabbageAndPotatoes: Recipe = {
    id: 133,
    ...
    ingredients: [
        ...
        { key: '3', ingredientIcon: potato, ingredientName: 'Картофель', grossWeight: 107, netWeight: 80 },
        { key: '4', ingredientIcon: carrot, ingredientName: 'Морковь', grossWeight: 50, netWeight: 40 },
        { key: '5', ingredientIcon: onion, ingredientName: 'Лук репчатый', grossWeight: 48, netWeight: 40 },
        { key: '6', ingredientIcon: tomato, ingredientName: 'Томатное пюре', grossWeight: 30, netWeight: 30 },
        { key: '7', ingredientIcon: cookingOil, ingredientName: 'Кулинарный жир', grossWeight: 20, netWeight: 20 },
        { key: '8', ingredientIcon: sugar, ingredientName: 'Сахар', grossWeight: 10, netWeight: 10 },
        { key: '9', ingredientIcon: vinegar, ingredientName: 'Уксус 3%-ный', grossWeight: 16, netWeight: 16 },
        { key: '10', ingredientIcon: water, ingredientName: 'Бульон или вода', grossWeight: 800, netWeight: 800 }
    ],
    output: 1000,
